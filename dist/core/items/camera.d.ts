...
import { ISourceCamera } from '../source/icamera';
/**
 ...
 *  instance.
 */
export declare class CameraItem extends Item implements IItemLayout, IItemColor, IItemChroma, IItemTransition, IAudio, IItemEffect, ISourceCamera {
    /**
