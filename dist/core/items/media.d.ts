...
import { ISourcePlayback, ActionAfterPlayback } from '../source/iplayback';
...
import { ISourceMedia } from '../source/imedia';
/**
 ...
 *  instance.
 */
export declare class MediaItem extends Item implements IItemLayout, IItemColor, IItemChroma, IItemTransition, ISourcePlayback, IAudio, IItemEffect, ISourceMedia {
     ...
     */
    bringForward: () => Promise<MediaItem>;
    /**
     ...
     */
    sendBackward: () => Promise<MediaItem>;
    /**
