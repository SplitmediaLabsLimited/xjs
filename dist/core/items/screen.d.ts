...
import { ISourceScreen } from '../source/iscreen';
/**
 ...
 *  instance.
 */
export declare class ScreenItem extends Item implements IItemLayout, IItemColor, IItemChroma, IItemTransition, IItemEffect, ISourceScreen {
    /**
