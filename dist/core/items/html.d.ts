...
import { ISourceHtml } from '../source/ihtml';
/**
 ...
 */
export declare class HtmlItem extends Item implements IItemLayout, IItemColor, IItemChroma, IItemTransition, ISourceConfigurable, IAudio, IItemEffect, ISourceHtml {
    /**
