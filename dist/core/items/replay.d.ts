...
import { ISourceReplay } from '../source/ireplay';
export declare class ReplayItem extends Item implements IItemLayout, IItemColor, IItemChroma, IItemTransition, IAudio, IItemEffect, ISourceReplay {
    /**
