...
import { ISourceImage } from '../source/iimage';
/**
 ...
 *  instance.
 */
export declare class ImageItem extends Item implements IItemLayout, IItemColor, IItemChroma, IItemTransition, IItemEffect, ISourceImage {
     ...
     */
    bringForward: () => Promise<ImageItem>;
    /**
     * See: {@link #core/IItemLayout#bringToFront bringToFront}
     */
    bringToFront: () => Promise<ImageItem>;
    /**
