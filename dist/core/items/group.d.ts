...
import { IItemColor } from './icolor';
import { IItemGroup } from './igroup';
import { IItemChroma, KeyingType, ChromaPrimaryColors, ChromaAntiAliasLevel } from './ichroma';
import { IItemEffect, MaskEffect } from './ieffects';
import { IItemTransition } from './itransition';
 ...
 *  instance.
 */
export declare class GroupItem extends Item implements IItemLayout, IItemColor, IItemChroma, IItemTransition, IItemEffect, IItemGroup {
    /**
     * See: {@link #core/IItemLayout#bringForward bringForward}
     */
    bringForward: () => Promise<GroupItem>;
    /**
     * See: {@link #core/IItemLayout#bringToFront bringToFront}
     */
    bringToFront: () => Promise<GroupItem>;
    /**
     ...
     */
    setChromaEnabled: (value: boolean) => Promise<GroupItem>;
    /**
     ...
     */
    setKeyingType: (value: KeyingType) => Promise<GroupItem>;
    /**
     ...
     */
    setChromaAntiAliasLevel: (value: ChromaAntiAliasLevel) => Promise<GroupItem>;
    /**
     ...
     */
    setChromaLegacyBrightness: (value: number) => Promise<GroupItem>;
    /**
     ...
     */
    setChromaLegacySaturation: (value: number) => Promise<GroupItem>;
    /**
     ...
     */
    setChromaLegacyHue: (value: number) => Promise<GroupItem>;
    /**
     ...
     */
    setChromaLegacyThreshold: (value: number) => Promise<GroupItem>;
    /**
     ...
     */
    setChromaLegacyAlphaSmoothing: (value: number) => Promise<GroupItem>;
    /**
     ...
     */
    setChromaRGBKeyPrimaryColor: (value: ChromaPrimaryColors) => Promise<GroupItem>;
    /**
     ...
     */
    setChromaRGBKeyThreshold: (value: number) => Promise<GroupItem>;
    /**
     ...
     */
    setChromaRGBKeyExposure: (value: number) => Promise<GroupItem>;
    /**
     ...
     */
    setChromaColorKeyThreshold: (value: number) => Promise<GroupItem>;
    /**
     ...
     */
    setChromaColorKeyExposure: (value: number) => Promise<GroupItem>;
    /**
     ...
     */
    setChromaColorKeyColor: (value: Color) => Promise<GroupItem>;
    /**
     ...
     */
    setVisible: (value: boolean) => Promise<GroupItem>;
    /**
     ...
     */
    setTransition: (value: Transition) => Promise<GroupItem>;
    /**
     ...
     */
    setTransitionTime: (value: number) => Promise<GroupItem>;
    ...
    setMaskEffect: (value: MaskEffect) => Promise<GroupItem>;
    ...
    setBorderEffectRadius: (value: number) => Promise<GroupItem>;
    ...
    setBorderEffectThickness: (value: number) => Promise<GroupItem>;
    ...
    setBorderEffectOpacity: (value: number) => Promise<GroupItem>;
    ...
    setBorderEffectColor: (value: Color) => Promise<GroupItem>;
    ...
    setShadowEffectColor: (value: Color) => Promise<GroupItem>;
    ...
    setShadowEffectThickness: (value: number) => Promise<GroupItem>;
    ...
    setShadowEffectBlur: (value: number) => Promise<GroupItem>;
    ...
    setShadowEffectOpacity: (value: number) => Promise<GroupItem>;
    ...
    setShadowEffectOffsetX: (value: number) => Promise<GroupItem>;
    ...
    setShadowEffectOffsetY: (value: number) => Promise<GroupItem>;
    ...
    setFileMask: (value: string) => Promise<GroupItem>;
    ...
    showFileMaskingGuide: (value: boolean) => Promise<GroupItem>;
    ...
    removeFilter: () => Promise<GroupItem>;
    /** See: {@link #core/IItemEffect#getFilterConfig getFilterConfig} */
    getFilterConfig: () => Promise<Object>;
    /** See: {@link #core/IItemEffect#unGroup unGroup} */
    unGroup: () => Promise<GroupItem>;
    /** See: {@link #core/IItemEffect#getItems getItems} */
    getItems: () => Promise<Item[]>;
    /** See: {@link #core/IItemEffect#addItems addItems} */
    addItems: (items: any) => Promise<GroupItem>;
    /** See: {@link #core/IItemEffect#removeItems removeItems} */
    removeItems: (items: any) => Promise<GroupItem>;
}
