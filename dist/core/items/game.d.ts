...
import { ISourceGame } from '../source/igame';
/**
 ...
 *  instance.
 */
export declare class GameItem extends Item implements IItemLayout, IItemColor, IItemChroma, IItemTransition, IItemEffect, ISourceGame {
    /**
