...
export declare class SceneItem extends Item implements IItemLayout, IItemColor, IItemChroma, IItemTransition, IAudio, IItemEffect, ISourceScene {
     ...
     */
    bringForward: () => Promise<SceneItem>;
    /**
     * See: {@link #core/IItemLayout#bringToFront bringToFront}
     */
    bringToFront: () => Promise<SceneItem>;
    /**
     ...
     */
    setChromaEnabled: (value: boolean) => Promise<SceneItem>;
    /**
     ...
     */
    setKeyingType: (value: KeyingType) => Promise<SceneItem>;
    /**
     ...
     */
    setChromaAntiAliasLevel: (value: ChromaAntiAliasLevel) => Promise<SceneItem>;
    /**
     ...
     */
    setChromaLegacyBrightness: (value: number) => Promise<SceneItem>;
    /**
     ...
     */
    setChromaLegacySaturation: (value: number) => Promise<SceneItem>;
    /**
     ...
     */
    setChromaLegacyHue: (value: number) => Promise<SceneItem>;
    /**
     ...
     */
    setChromaLegacyThreshold: (value: number) => Promise<SceneItem>;
    /**
     ...
     */
    setChromaLegacyAlphaSmoothing: (value: number) => Promise<SceneItem>;
    /**
     ...
     */
    setChromaRGBKeyPrimaryColor: (value: ChromaPrimaryColors) => Promise<SceneItem>;
    /**
     ...
     */
    setChromaRGBKeyThreshold: (value: number) => Promise<SceneItem>;
    /**
     ...
     */
    setChromaRGBKeyExposure: (value: number) => Promise<SceneItem>;
    /**
     ...
     */
    setChromaColorKeyThreshold: (value: number) => Promise<SceneItem>;
    /**
     ...
     */
    setChromaColorKeyExposure: (value: number) => Promise<SceneItem>;
    /**
     ...
     */
    setChromaColorKeyColor: (value: Color) => Promise<SceneItem>;
    /**
     ...
     */
    setVisible: (value: boolean) => Promise<SceneItem>;
    /**
     ...
     */
    setTransition: (value: Transition) => Promise<SceneItem>;
    /**
     ...
     */
    setTransitionTime: (value: number) => Promise<SceneItem>;
    ...
    setMaskEffect: (value: MaskEffect) => Promise<SceneItem>;
    ...
    setBorderEffectRadius: (value: number) => Promise<SceneItem>;
    ...
    setBorderEffectThickness: (value: number) => Promise<SceneItem>;
    ...
    setBorderEffectOpacity: (value: number) => Promise<SceneItem>;
    ...
    setBorderEffectColor: (value: Color) => Promise<SceneItem>;
    ...
    setShadowEffectColor: (value: Color) => Promise<SceneItem>;
    ...
    setShadowEffectThickness: (value: number) => Promise<SceneItem>;
    ...
    setShadowEffectBlur: (value: number) => Promise<SceneItem>;
    ...
    setShadowEffectOpacity: (value: number) => Promise<SceneItem>;
    ...
    setShadowEffectOffsetX: (value: number) => Promise<SceneItem>;
    ...
    setShadowEffectOffsetY: (value: number) => Promise<SceneItem>;
    ...
    setFileMask: (value: string) => Promise<SceneItem>;
    ...
    showFileMaskingGuide: (value: boolean) => Promise<SceneItem>;
