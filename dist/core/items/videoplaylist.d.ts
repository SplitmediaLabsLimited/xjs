...
import { ISourceConfigurable } from '../source/iconfig';
 ...
 * ```
 */
export declare class VideoPlaylistItem extends Item implements IItemLayout, IItemColor, IItemChroma, IItemTransition, ISourceConfigurable, ISourceVideoPlaylist, ISourcePlayback, IAudio {
    /**
