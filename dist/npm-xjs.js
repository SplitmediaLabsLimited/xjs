module.exports = (function() {
    var _require=(function e(t,n,r){function s(o,u){if(!n[o]){if(!t[o]){var a=typeof _require=="function"&&_require;if(!u&&a)return a(o,!0);if(i)return i(o,!0);var f=new Error("Cannot find module '"+o+"'");throw f.code="MODULE_NOT_FOUND",f}var l=n[o]={exports:{}};t[o][0].call(l.exports,function(e){var n=t[o][1][e];return s(n?n:e)},l,l.exports,e,t,n,r)}return n[o].exports}var i=typeof _require=="function"&&_require;for(var o=0;o<r.length;o++)s(r[o]);return s})({1:[function(_require,module,exports){
    ...
    exports.App = App;
    },{"../internal/app":17,"../internal/util/json":22,"../internal/util/xml":24,"../system/audio":25,"../util/rectangle":34,"./transition":16}],2:[function(_require,module,exports){
    var app_1 = _require('../internal/app');
    ...
    },{"../internal/app":17}],3:[function(_require,module,exports){
    /**
    ...
    },{"../../internal/item":21,"../../internal/util/mixin":23,"../environment":3,"./iaudio":8,"./item":13}],5:[function(_require,module,exports){
    /// <reference path="../../../defs/es6-promise.d.ts" />
    var __extends = (this && this.__extends) || function (d, b) {
        for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p];
        function __() { this.constructor = d; }
    ...
    },{"../../internal/item":21,"../../internal/util/mixin":23,"./ichroma":9,"./icolor":10,"./ilayout":12,"./item":13,"./itransition":14}],6:[function(_require,module,exports){
    /// <reference path="../../../defs/es6-promise.d.ts" />
    var __extends = (this && this.__extends) || function (d, b) {
        for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p];
        function __() { this.constructor = d; }
    ...
    },{"../../internal/item":21,"../../internal/util/json":22,"../../internal/util/mixin":23,"../../internal/util/xml":24,"../environment":3,"./ichroma":9,"./icolor":10,"./ilayout":12,"./item":13,"./itransition":14}],7:[function(_require,module,exports){
    /// <reference path="../../../defs/es6-promise.d.ts" />
    var __extends = (this && this.__extends) || function (d, b) {
        for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p];
        function __() { this.constructor = d; }
    ...
    },{"../../internal/internal":20,"../../internal/item":21,"../../internal/util/mixin":23,"../../util/rectangle":34,"../environment":3,"./ichroma":9,"./icolor":10,"./iconfig":11,"./ilayout":12,"./item":13,"./itransition":14}],8:[function(_require,module,exports){
    /// <reference path="../../../defs/es6-promise.d.ts" />
    var item_1 = _require('../../internal/item');
    var environment_1 = _require('../environment');
    ...
    },{"../../internal/item":21,"../environment":3}],9:[function(_require,module,exports){
    /// <reference path="../../../defs/es6-promise.d.ts" />
    var item_1 = _require('../../internal/item');
    ...
    },{"../../internal/item":21,"../../util/color":30}],10:[function(_require,module,exports){
    /// <reference path="../../../defs/es6-promise.d.ts" />
    var item_1 = _require('../../internal/item');
    var color_1 = _require('../../util/color');
    ...
    },{"../../internal/item":21,"../../util/color":30}],11:[function(_require,module,exports){
    /// <reference path="../../../defs/es6-promise.d.ts" />
    var item_1 = _require('../../internal/item');
    ...
    },{"../../internal/global":18,"../../internal/internal":20,"../../internal/item":21,"../environment":3}],12:[function(_require,module,exports){
    /// <reference path="../../../defs/es6-promise.d.ts" />
    var item_1 = _require('../../internal/item');
    var rectangle_1 = _require('../../util/rectangle');
    ...
    },{"../../internal/item":21,"../../util/rectangle":34}],13:[function(_require,module,exports){
    /// <reference path="../../../defs/es6-promise.d.ts" />
    var mixin_1 = _require('../../internal/util/mixin');
    var item_1 = _require('../../internal/item');
    var environment_1 = _require('../environment');
    ...
    },{"../../internal/item":21,"../../internal/util/json":22,"../../internal/util/mixin":23,"../../internal/util/xml":24,"../environment":3,"../scene":15,"./ilayout":12}],14:[function(_require,module,exports){
    /// <reference path="../../../defs/es6-promise.d.ts" />
    var item_1 = _require('../../internal/item');
    var transition_1 = _require('../transition');
    ...
    },{"../../internal/item":21,"../transition":16}],15:[function(_require,module,exports){
    /// <reference path="../../defs/es6-promise.d.ts" />
    var json_1 = _require('../internal/util/json');
    var xml_1 = _require('../internal/util/xml');
    var app_1 = _require('../internal/app');
    ...
    exports.Scene = Scene;
    },{"../internal/app":17,"../internal/internal":20,"../internal/util/json":22,"../internal/util/xml":24,"./environment":3,"./item/audio":4,"./item/camera":5,"./item/game":6,"./item/html":7,"./item/item":13}],16:[function(_require,module,exports){
    /**
    ...
    exports.App = App;
    },{"./internal":20,"./util/json":22}],18:[function(_require,module,exports){
    /// <reference path="../../defs/es6-promise.d.ts" />
    var Global = (function () {
        function Global() {
        }
    ...
    init();
    },{"../core/environment":3,"../window/config":35,"./global":18,"./internal":20,"./item":21}],20:[function(_require,module,exports){
    ...
    */
    ...
    exports.Item = Item;
    },{"../core/environment":3,"./internal":20}],22:[function(_require,module,exports){
    ...
    exports.JSON = JSON;
    },{"./xml":24}],23:[function(_require,module,exports){
    ...
    },{"../internal/util/json":22,"../internal/util/xml":24}],26:[function(_require,module,exports){
    /// <reference path="../../defs/es6-promise.d.ts" />
    var json_1 = _require('../internal/util/json');
    var xml_1 = _require('../internal/util/xml');
    var app_1 = _require('../internal/app');
    ...
    },{"../internal/app":17,"../internal/util/json":22,"../internal/util/xml":24}],27:[function(_require,module,exports){
    /// <reference path="../../defs/es6-promise.d.ts" />
    var rectangle_1 = _require('../util/rectangle');
    var json_1 = _require('../internal/util/json');
    var xml_1 = _require('../internal/util/xml');
    ...
    exports.Game = Game;
    },{"../internal/app":17,"../internal/util/json":22,"../internal/util/xml":24,"../util/rectangle":34}],28:[function(_require,module,exports){
    /// <reference path="../../defs/es6-promise.d.ts" />
    var json_1 = _require('../internal/util/json');
    var xml_1 = _require('../internal/util/xml');
    var app_1 = _require('../internal/app');
    ...
    },{"../internal/app":17,"../internal/util/json":22,"../internal/util/xml":24}],29:[function(_require,module,exports){
    /// <reference path="../../defs/es6-promise.d.ts" />
    var app_1 = _require('../internal/app');
    ...
    },{"../core/environment":3,"../internal/app":17,"../internal/internal":20,"./audio":25,"./camera":26,"./game":27,"./microphone":28}],30:[function(_require,module,exports){
    var Color = (function () {
    ...
    exports.IO = IO;
    },{"../internal/internal":20}],33:[function(_require,module,exports){
    /// <reference path="../../defs/es6-promise.d.ts" />
    var isReady = false;
    ...
    },{"../internal/internal":20,"../util/eventemitter":31}],36:[function(_require,module,exports){
    /// <reference path="../../defs/es6-promise.d.ts" />
    var rectangle_1 = _require('../util/rectangle');
    var environment_1 = _require('../core/environment');
    var internal_1 = _require('../internal/internal');
    ...
    },{"../core/environment":3,"../internal/internal":20,"../util/rectangle":34}],37:[function(_require,module,exports){
    /// <reference path="../../defs/es6-promise.d.ts" />
    var __extends = (this && this.__extends) || function (d, b) {
        for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p];
        function __() { this.constructor = d; }
    ...
    },{"../core/environment":3,"../internal/app":17,"../util/eventemitter":31}],38:[function(_require,module,exports){
    /// <reference path="../../defs/es6-promise.d.ts" />
    var __extends = (this && this.__extends) || function (d, b) {
        for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p];
        function __() { this.constructor = d; }
    ...
    },{"../core/environment":3,"../util/eventemitter":31}],"xjs":[function(_require,module,exports){
    function __export(m) {
