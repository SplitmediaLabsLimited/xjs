...
assert.match(index, /\.\.\/\.\.\/docs\/app\/js\/xsplit-doc-shell\.js/, 'extension should load reconstructed docs shell components');
...
assert.match(index, /<xsplit-doc-search><\/xsplit-doc-search>/, 'extension should render the docs search fixture');
...
assert.match(fixtures, /xsplit-doc-search/, 'fixture manifest should include the docs search fixture');
...
assert.match(fixtures, /expectedSelectors/, 'fixture manifest should record expected rendered selectors');
