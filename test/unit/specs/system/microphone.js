...
describe('Microphone', () => {
  ...
  describe('should list microphone devices', () => {
    ...
    it('with correct properties', (done) => {
      promise.then((devices) => {
        expect(devices).eachHasMethods(['getName', 'getDisplayId'].join(','));
        done();
      });
    });
  });

  describe('system microphone devices', () => {
    var promise;
