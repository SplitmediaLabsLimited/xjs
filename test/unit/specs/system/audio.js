        ...
        spyOn(window.external, 'AppGetPropertyAsync')
          .and.callFake(function(funcName) {
            if(funcName === 'wasapienum') {
              ...
              setTimeout(function() {
                window.OnAsyncCallback(randomNumber, '<list><dev name="Microphone (HD Webcam C615)" adapter="HD Webcam C615" adapterdev="Microphone" id="{0.0.1.00000000}.{b7709bea-527e-4f60-afb0-cd36431972ad}" DataFlow="Capture" State="Active" DSoundGuid="{B7709BEA-527E-4F60-AFB0-CD36431972AD}" WaveId="1"/></list>');
              }, 10);
            }
          });
      }
