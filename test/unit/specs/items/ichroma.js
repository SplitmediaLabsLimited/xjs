...
describe('Chroma interface', () => {
  ...
  it('contains all the necessary chroma methods', () => {
    var methods = [
      'isChromaEnabled',
      'setChromaEnabled',
      'getKeyingType',
  ...
  describe('should be able to get and set if chroma is enabled', () => {
    ...
    it('as a boolean', (done) => {
      ...
      firstItem
        .setChromaEnabled(firstBoolean)
        .then(() => secondItem.setChromaEnabled(secondBoolean))
        .then(() => firstItem.isChromaEnabled())
        .then((enabled1) => {
  ...
  describe('should be able to get and set keying type', () => {
    it('through a promise', (done) => {
    ...
    it('as a number', (done) => {
      var keyingType = [XJS.KeyingType.LEGACY, XJS.KeyingType.COLORKEY, XJS.KeyingType.RGBKEY];

      var firstRand = keyingType[randomInt(0, 2)];
      var secondRand = keyingType[randomInt(0, 2)];

      firstItem
        .setKeyingType(firstRand)
        .then(() => secondItem.setKeyingType(secondRand))
        .then(() => firstItem.getKeyingType())
        .then((keying1) => {
  ...
  describe('should be able to get and set chroma antialising level', () => {
    it('through a promise', (done) => {
    ...
    it('as a number', (done) => {
      ...
      firstItem
        .setChromaAntiAliasLevel(firstRand)
        .then(() => secondItem.setChromaAntiAliasLevel(secondRand))
        .then(() => firstItem.getChromaAntiAliasLevel())
        .then((aalevel1) => {
    ...
    it('which rejects for invalid parameters', (done) => {
      ...
      firstItem
        .setChromaAntiAliasLevel(randomString)
        .then(() => {
          done.fail('Invalid type was accepted (string)');
        })
        .catch((err) => {
  ...
  describe('should be able to get and set chroma legacy brightness', () => {
    it('through a promise', (done) => {
    ...
    it('as a number', (done) => {
      ...
      firstItem
        .setChromaLegacyBrightness(firstRand)
        .then(() => secondItem.setChromaLegacyBrightness(secondRand))
        .then(() => firstItem.getChromaLegacyBrightness())
        .then((brightness1) => {
    ...
    it('which rejects for invalid parameters', (done) => {
      ...
      firstItem
        .setChromaLegacyBrightness(randomString)
        .then(() => {
          done.fail('Invalid type was accepted (string)');
        })
        .catch((err) => {
  ...
  describe('should be able to get and set chroma legacy saturation', () => {
    it('through a promise', (done) => {
    ...
    it('as a number', (done) => {
      ...
      firstItem
        .setChromaLegacySaturation(firstRand)
        .then(() => secondItem.setChromaLegacySaturation(secondRand))
        .then(() => firstItem.getChromaLegacySaturation())
        .then((saturation1) => {
    ...
    it('which rejects for invalid parameters', (done) => {
      ...
      firstItem
        .setChromaLegacySaturation(randomString)
        .then(() => {
          done.fail('Invalid type was accepted (string)');
        })
        .catch((err) => {
  ...
  describe('should be able to get and set chroma legacy hue', () => {
    it('through a promise', (done) => {
    ...
    it('as a number', (done) => {
      ...
      firstItem
        .setChromaLegacyHue(firstRand)
        .then(() => secondItem.setChromaLegacyHue(secondRand))
        .then(() => firstItem.getChromaLegacyHue())
        .then((hue1) => {
    ...
    it('which rejects for invalid parameters', (done) => {
      ...
      firstItem
        .setChromaLegacyHue(randomString)
        .then(() => {
          done.fail('Invalid type was accepted (string)');
        })
        .catch((err) => {
  ...
  describe('should be able to get and set chroma legacy threshold', () => {
    it('through a promise', (done) => {
    ...
    it('as a number', (done) => {
      ...
      firstItem
        .setChromaLegacyThreshold(firstRand)
        .then(() => secondItem.setChromaLegacyThreshold(secondRand))
        .then(() => firstItem.getChromaLegacyThreshold())
        .then((threshold1) => {
    ...
    it('which rejects for invalid parameters', (done) => {
      ...
      firstItem
        .setChromaLegacyThreshold(randomString)
        .then(() => {
          done.fail('Invalid type was accepted (string)');
        })
        .catch((err) => {
  ...
  describe('should be able to get and set chroma legacy alpha smoothing', () => {
    it('through a promise', (done) => {
    ...
    it('as a number', (done) => {
      ...
      firstItem
        .setChromaLegacyAlphaSmoothing(firstRand)
        .then(() => secondItem.setChromaLegacyAlphaSmoothing(secondRand))
        .then(() => firstItem.getChromaLegacyAlphaSmoothing())
        .then((smoothing1) => {
    ...
    it('which rejects for invalid parameters', (done) => {
      ...
      firstItem
        .setChromaLegacyAlphaSmoothing(randomString)
        .then(() => {
          done.fail('Invalid type was accepted (string)');
        })
        .catch((err) => {
  ...
  describe('should be able to get and set keying type', () => {
    ...
    it('as a number', (done) => {
      ...
      firstItem
        .setChromaRGBKeyPrimaryColor(firstRand)
        .then(() => secondItem.setChromaRGBKeyPrimaryColor(secondRand))
        .then(() => firstItem.getChromaRGBKeyPrimaryColor())
        .then((color1) => {
    ...
    it('which rejects for invalid parameters', (done) => {
      ...
      firstItem
        .setChromaRGBKeyPrimaryColor(randomString)
        .then(() => {
          done.fail('Invalid type was accepted (string)');
        })
        .catch((err) => {
  ...
  describe('should be able to get and set chroma rgb key threshold', () => {
    it('through a promise', (done) => {
    ...
    it('as a number', (done) => {
      ...
      firstItem
        .setChromaRGBKeyThreshold(firstRand)
        .then(() => secondItem.setChromaRGBKeyThreshold(secondRand))
        .then(() => firstItem.getChromaRGBKeyThreshold())
        .then((threshold1) => {
          expect(threshold1).toBeTypeOf('number');
          expect(threshold1).toEqual(firstRand);
    ...
    it('which rejects for invalid parameters', (done) => {
      ...
      firstItem
        .setChromaRGBKeyThreshold(randomString)
        .then(() => {
          done.fail('Invalid type was accepted (string)');
        })
        .catch((err) => {
  ...
  describe('should be able to get and set chroma rgb key exposure', () => {
    it('through a promise', (done) => {
    ...
    it('as a number', (done) => {
      ...
      firstItem
        .setChromaRGBKeyExposure(firstRand)
        .then(() => secondItem.setChromaRGBKeyExposure(secondRand))
        .then(() => firstItem.getChromaRGBKeyExposure())
        .then((exposure1) => {
    ...
    it('which rejects for invalid parameters', (done) => {
      ...
      firstItem
        .setChromaRGBKeyExposure(randomString)
        .then(() => {
          done.fail('Invalid type was accepted (string)');
        })
        .catch((err) => {
  ...
  describe('should be able to get and set chroma color key threshold', () => {
    it('through a promise', (done) => {
    ...
    it('as a number', (done) => {
      ...
      firstItem
        .setChromaColorKeyThreshold(firstRand)
        .then(() => secondItem.setChromaColorKeyThreshold(secondRand))
        .then(() => firstItem.getChromaColorKeyThreshold())
        .then((threshold1) => {
          expect(threshold1).toBeTypeOf('number');
          expect(threshold1).toEqual(firstRand);
    ...
    it('which rejects for invalid parameters', (done) => {
      ...
      firstItem
        .setChromaColorKeyThreshold(randomString)
        .then(() => {
          done.fail('Invalid type was accepted (string)');
        })
        .catch((err) => {
  ...
  describe('should be able to get and set chroma color key exposure', () => {
    it('through a promise', (done) => {
    ...
    it('as a number', (done) => {
      ...
      firstItem
        .setChromaColorKeyExposure(firstRand)
        .then(() => secondItem.setChromaColorKeyExposure(secondRand))
        .then(() => firstItem.getChromaColorKeyExposure())
        .then((exposure1) => {
          expect(exposure1).toBeTypeOf('number');
          expect(exposure1).toEqual(firstRand);
    ...
    it('which rejects for invalid parameters', (done) => {
      ...
      firstItem
        .setChromaColorKeyExposure(randomString)
        .then(() => {
          done.fail('Invalid type was accepted (string)');
        })
        .catch((err) => {
  ...
  describe('should be able to get and set chroma color key color', () => {
    it('through a promise', (done) => {
    ...
    it('as a Color object', (done) => {
      ...
      firstItem
        .setChromaColorKeyColor(randomColorKey)
        .then(() => {
        ...
        .then(() => firstItem.getChromaColorKeyColor())
        .then((color) => {
