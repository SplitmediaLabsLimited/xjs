...
describe('ImageItem', () => {
  ...
  it('should be detected by getItems() correctly', (done) => {
    ...
    var gifItems = [].filter.call(fileTypeItems, (node) =>
      /\.gif$/.test(node.getAttribute('item'))
    );
