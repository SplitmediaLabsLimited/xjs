...
describe('Layout interface', () => {
  ...
  it('contains all the necessary layouts methods', () => {
    var methods = [
      'isKeepAspectRatio',
      'setKeepAspectRatio',
      'isPositionLocked',
  ...
  describe('should be able to get and set if keep aspect ratio is enabled', () => {
    ...
    it('as a boolean', (done) => {
      ...
      firstItem
        .setKeepAspectRatio(firstBoolean)
        .then(() => secondItem.setKeepAspectRatio(secondBoolean))
        .then(() => firstItem.isKeepAspectRatio())
        .then((enabled1) => {
  ...
  describe('should be able to get and set if position locked is enabled', () => {
    it('through a promise', (done) => {
    ...
    it('as a boolean', (done) => {
      ...
      firstItem
        .setPositionLocked(firstBoolean)
        .then(() => secondItem.setPositionLocked(secondBoolean))
        .then(() => firstItem.isPositionLocked())
        .then((enabled1) => {
          expect(enabled1).toBeTypeOf('boolean');
          expect(enabled1).toEqual(firstBoolean);
  ...
  describe('should be able to get and set if enhanced resize is enabled', () => {
    it('through a promise', (done) => {
    ...
    it('as a boolean', (done) => {
      ...
      firstItem
        .setEnhancedResizeEnabled(firstBoolean)
        .then(() => secondItem.setEnhancedResizeEnabled(secondBoolean))
        .then(() => firstItem.isEnhancedResizeEnabled())
        .then((enabled1) => {
          expect(enabled1).toBeTypeOf('boolean');
          expect(enabled1).toEqual(firstBoolean);
  ...
  describe('should be able to get and set position', () => {
    ...
    it('as a Rectangle object', (done) => {
      firstItem
        .setPosition(firstRec)
        .then(() => firstItem.getPosition())
        .then((rec1) => {
  ...
  describe('should be able to get and set Y rotation', () => {
    it('through a promise', (done) => {
    ...
    it('as a number', (done) => {
      ...
      firstItem
        .setRotateY(firstRand)
        .then(() => secondItem.setRotateY(secondRand))
        .then(() => firstItem.getRotateY())
        .then((rotation1) => {
  ...
  describe('should be able to get and set X rotation', () => {
    it('through a promise', (done) => {
    ...
    it('as a number', (done) => {
      ...
      firstItem
        .setRotateX(firstRand)
        .then(() => secondItem.setRotateX(secondRand))
        .then(() => firstItem.getRotateX())
        .then((action1) => {
  ...
  describe('should be able to get and set Z rotation', () => {
    it('through a promise', (done) => {
    ...
    it('as a number', (done) => {
      ...
      firstItem
        .setRotateZ(firstRand)
        .then(() => secondItem.setRotateZ(secondRand))
        .then(() => firstItem.getRotateZ())
        .then((rotation1) => {
          expect(rotation1).toBeTypeOf('number');
          expect(rotation1).toEqual(firstRand);
  ...
  describe('should be able to get and set cropping', () => {
    var leftRand = randomInt(1, 500) / 1000;
    var topRand = randomInt(1, 500) / 1000;
    ...
    it('as an object', (done) => {
      firstItem
        .setCropping(coordObj)
        .then(() => firstItem.getCropping())
        .then((obj) => {
  ...
  describe('should be able to get and set canvas rotation', () => {
    ...
    it('as a number', (done) => {
      ...
      firstItem
        .setCanvasRotate(firstRand)
        .then(() => secondItem.setCanvasRotate(secondRand))
        .then(() => firstItem.getCanvasRotate())
        .then((rotation1) => {
          expect(rotation1).toEqual(firstRand);
  ...
  describe('should be able to get and set enhanced canvas rotation', () => {
    it('through a promise', (done) => {
    ...
    it('as a number', (done) => {
      ...
      firstItem
        .setPosition(posRec)
        .then(() => firstItem.setEnhancedRotate(randRotate))
        .then(() => firstItem.getEnhancedRotate())
        .then((canvasRotation) => {
    ...
    it('which rejects for invalid parameters', (done) => {
      ...
      firstItem
        .setEnhancedRotate(randomString)
        .then(() => {
          done.fail('Invalid type was accepted (string)');
        })
        .catch((err) => {
  ...
  describe('should be able to set cropping in an enhanced state', () => {
    var leftRand = randomInt(1, 500) / 1000;
    var topRand = randomInt(1, 500) / 1000;
    var rightRand = randomInt(1, 500) / 1000;
    var bottomRand = randomInt(1, 500) / 1000;
    ...
    it('as an object', (done) => {
      ...
      firstItem
        .setPosition(posRec)
        .then(() => firstItem.setEnhancedRotate(randRotate))
        .then(() => firstItem.setCropping(origCoordObj))
        .then(() => firstItem.setCroppingEnhanced(coordObj))
        .then(() => firstItem.getCropping())
        .then((obj) => {
          expect(obj).toBeInstanceOf(Object);
          expect(obj.left).toEqual(coordObj.left);
    ...
    it('which rejects for invalid parameters', (done) => {
      ...
      firstItem
        .setCroppingEnhanced(randomString)
        .then(() => {
          done.fail('Invalid type was accepted (string)');
        })
        .catch((err) => {
