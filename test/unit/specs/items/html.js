...
describe('HtmlItem', function() {
  ...
  var getLocal = function(funcName) {
    ...
    switch (funcName) {
      ...
      case 'prop:RefreshOnSrcShow':
        if (local.hasOwnProperty('RefreshOnSrcShow')) {
          setTimeout(function() {
      ...
      case 'prop:RefreshOnScnLoad':
        if (local.hasOwnProperty('RefreshOnScnLoad')) {
  ...
  describe('HtmlItem-specific methods checking', function() {
    ...
    it('should be able to get if reload on show is enabled',
      function(done) {
        exec(function(next) {
    ...
    it('should be able to enable or disable reload on show',
      function(done) {
        exec(function(next) {
          var testBoolean = randomBoolean();
          var promise = currentHtmlItem.enableReloadOnShow(testBoolean);
          promise.then(function() {
            return currentHtmlItem.isReloadOnShowEnabled();
          })
          .then(function(firstEnabled) {
            expect(firstEnabled).toBe(testBoolean);
    ...
    it('should be able to enable or disable reload on scene enter',
      function(done) {
        exec(function(next) {
          var testBoolean = randomBoolean();
