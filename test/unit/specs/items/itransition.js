...
describe('Transition interface', () => {
  ...
  it('contains all the necessary transition methods', () => {
    var methods = [
      'isVisible',
      'setVisible',
      'getTransition',
  ...
  describe('should be able to get and set visibility', () => {
    ...
    it('as a boolean', (done) => {
      ...
      firstItem
        .setVisible(firstBoolean)
        .then(() => secondItem.setVisible(secondBoolean))
        .then(() => firstItem.isVisible())
        .then((visible1) => {
  ...
  describe('should be able to get and set source transitions', () => {
    ...
    it('as a Transition object', (done) => {
      ...
      firstItem
        .setTransition(randomTransitionObj)
        .then(() => secondItem.setTransition(randomTransitionObj2))
        .then(() => firstItem.getTransition())
        .then((transition1) => {
  ...
  describe('should be able to get and set transition time', () => {
    it('through a promise', (done) => {
    ...
    it('as a number', (done) => {
      ...
      firstItem
        .setTransitionTime(firstRand)
        .then(() => secondItem.setTransitionTime(secondRand))
        .then(() => firstItem.getTransitionTime())
        .then((time1) => {
    ...
    it('which rejects for invalid parameters', (done) => {
      ...
      firstItem
        .setTransitionTime(randomString)
        .then(() => {
          done.fail('Invalid type was accepted (string)');
        })
        .catch((err) => {
