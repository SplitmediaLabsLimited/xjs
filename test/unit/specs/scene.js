...
describe('Scene ===', function() {
  ...
  describe('object instance', function() {
    ...
    it('should be able to search for an item by ID', function(done) {
      exec(function(next) {
        ...
        Scene.getActiveScene().then(function(result) {
          ...
          sceneItems = items[0];
          return Scene.searchItemById(sceneItems._id);
        }).then(function(item) {
    ...
    it('should be able to search for a source by source ID', function(done) {
      exec(function(next) {
        var scene;
        var sceneSource;
        Scene.getActiveScene().then(function(result) {
          ...
          console.log(sources)
          return Scene.searchSourceById(sceneSource._srcId);
    ...
    it('should be able to search by ID in a case-insensitive way', function(done) {
      exec(function(next) {
        ...
        Scene.getActiveScene().then(function(result) {
          ...
          sceneItems = items[0];
          return Scene.searchItemById(sceneItems._id.toLowerCase());
        }).then(function(item) {
          expect(item).toBeInstanceOf(Item);
          next();
        });
    ...
    it('should be able to get null when searching for nonexistent ID', function(done) {
      exec(function(next) {
        Scene.searchItemById('{AAAAAAAA-AAAA-AAAA-AAAA-AAAAAAAAAAAA}')
        .then(function(item) {
