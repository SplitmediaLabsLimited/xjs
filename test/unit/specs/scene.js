...
describe('Scene ===', () => {
  ...
  var mix = new window.Mixin([
    ...
    () => {
      navigator.__defineGetter__('appVersion', () => 'XSplit Broadcaster 3.0.1704.2101 ');
    },
  ]);
  ...
  describe('should be able to get current number of scenes', () => {
    beforeEach(() => {
      spyOn(window.external, 'AppGetPropertyAsync').and.callFake((funcName) => {
        ...
        if (funcName === 'scenecount') {
          ...
          setTimeout(() => {
            window.OnAsyncCallback(asyncId, encodeURIComponent(mockPresetConfig));
          }, 10);
        }
        return asyncId;
      });
  ...
  describe('should be able to fetch a specific scene by id', () => {
    beforeEach(() => {
      spyOn(window.external, 'AppGetPropertyAsync').and.callFake((funcName) => {
        ctr++;
        var asyncId = ctr;
      ...
      exec((next) => {
        Scene.getById(2)
          ...
          .then(
            ...
            (scene) => Scene.getById('Test string')
          )
          .then(
            () => {
  ...
  describe('should be able to fetch a specific scene by index', () => {
    beforeEach(() => {
      spyOn(window.external, 'AppGetPropertyAsync').and.callFake((funcName) => {
        ctr++;
        var asyncId = ctr;
      ...
      exec((next) => {
        Scene.getBySceneIndex(2)
          ...
          .then(
            ...
            (scene) => Scene.getBySceneIndex('Test string')
          )
          .then(
            () => {
  ...
  describe('should be able to fetch a specific scene by UID', () => {
    beforeEach(() => {
      spyOn(window.external, 'AppGetPropertyAsync').and.callFake((funcName) => {
        ctr++;
        var asyncId = ctr;
    ...
    it('asynchronously', (done) => {
      ...
      Scene.getBySceneUid('{239DB767-BE5B-4389-90C2-E712F08EA2CC}')
        ...
        .then(
          ...
          (scene) => Scene.getBySceneUid('{00000000-0000-0000-0000-000000000000}')
        )
        .then(
          () => {
  ...
  describe('should be able to fetch a specific scene by name', () => {
    beforeEach(() => {
      spyOn(window.external, 'AppGetPropertyAsync').and.callFake((funcName) => {
        ctr++;
        var asyncId = ctr;
        if (funcName === 'scenecount') {
          ...
          var name;
          if (
            sceneIndex === '{239DB767-BE5B-4389-90C2-E712F08EA2CC}' ||
            sceneIndex === '{219DB767-BE5B-4389-90C2-E712F08EA2CC}'
          ) {
            name = 'Scene 1';
    ...
    it('and return as an array of Scene objects', (done) => {
      exec((next) => {
  ...
  describe('should be able to fetch current scene', () => {
    beforeEach(() => {
      spyOn(window.external, 'AppGetPropertyAsync').and.callFake((funcName) => {
        ctr++;
        var asyncId = ctr;
    ...
    it('but is rejected when called from source plugin', (done) => {
      env.set(environments[2]);
      exec((next) => {
        Scene.getActiveScene().then(
          () => {
  ...
  describe('should be able to set current scene', () => {
    beforeEach(() => {
      spyOn(window.external, 'AppGetPropertyAsync').and.callFake((funcName) => {
        ctr++;
        var asyncId = ctr;
      ...
      spyOn(window.external, 'GetGlobalProperty').and.callFake((val) => {
        if (val === 'splitmode') {
          return '0';
        }
      });
    ...
    it('from an integer', (done) => {
      exec((next) => {
        var index = Math.floor(Math.random() * 2 + 1);

        Scene.setActiveScene(index)
          .then(() => Scene.getActiveScene())
          .then((currentScene) => {
    ...
    it('from a Scene object', (done) => {
      exec((next) => {
        var index = Math.floor(Math.random() * 2 + 1);
        Scene.getByName('Scene ' + index)
          .then((scene) => Scene.setActiveScene(scene[0]))
          .then((scene) => Scene.getActiveScene())
          .then((currentScene) => {
            expect(currentScene._id).toEqual(index - 1);
            next();
          });
    ...
    describe('but not', () => {
      it('for any other parameter', (done) => {
        exec((next) => {
      ...
      it('when called from source', (done) => {
        env.set(environments[2]);
        exec((next) => {
          Scene.setActiveScene(1).then(
            () => {
  ...
  describe('object instance', () => {
    ...
    beforeAll((done) => {
      ...
      spyOn(window.external, 'AppSetPropertyAsync').and.callFake((funcName, ...args) => {
        ctr++;
      ...
      spyOn(window.external, 'GetLocalPropertyAsync').and.callFake((prop) => {
        ctr++;
        switch (prop) {
          case 'prop:name':
            setTimeout(
          ...
          case 'prop:item':
            setTimeout(
              function () {
                window.OnAsyncCallback(
                  this,
                  'html:plugin:twitchchatplg*{&quot;manuallyConnected&quot;:&quot;Not Connected&quot;,&quot;connected&quot;:&quot;Not Connected&quot;,&quot;channel&quot;:&quot;&quot;,&quot;opacity&quot;:100,&quot;viewerColor&quot;:&quot;#627FFF&quot;,&quot;messageColor&quot;:&quot;#FFFFFF&quot;,&quot;viewerFont&quot;:&quot;Calibri&quot;,&quot;messageFont&quot;:&quot;Calibri&quot;,&quot;textSize&quot;:&quot;24&quot;}'
                );
              }.bind(ctr),
              10
            );
      ...
      spyOn(window.external, 'GetLocalPropertyAsync2').and.callFake((prop) => {
        ctr++;
        switch (prop) {
          case 'prop:name':
            setTimeout(
          ...
          case 'prop:item':
            setTimeout(
              function () {
                window.OnAsyncCallback(
                  this,
                  '@DEVICE:PNP:\\\\?\\USB#VID_046D&amp;PID_082C&amp;MI_02#6&amp;16FD2F8D&amp;0&amp;0002#{65E8773D-8F56-11D0-A3B9-00A0C9223196}\\GLOBAL'
                );
              }.bind(ctr),
              10
            );
    ...
    it('should be able to get the scene number', (done) => {
      exec((next) => {
        var scene;
    ...
    it('should be able to get the scene index', (done) => {
      exec((next) => {
        var scene;
        Scene.getActiveScene()
          .then((result) => {
    ...
    it('should be able to get the scene unique id', (done) => {
      exec((next) => {
        Scene.getActiveScene()
          .then((scene) => scene.getSceneUid())
          .then(
            (id) => {
            ...
            () => {
              if (navigator.appVersion.indexOf('XSplit Broadcaster 3.0.1704.2101 ') > -1) {
                  ...
                  'getSceneUid should not reject if called on XBC equal or higher than 3.0.1704.2101'
                );
              }
              next();
            }
    ...
    it('should be able to get and set the scene name', (done) => {
      exec((next) => {
        var scene;
    ...
    it('should be able to get the items', (done) => {
      exec((next) => {
        var scene;
        var sceneItems;
        Scene.getActiveScene()
    ...
    it('should be able to get only the top-level items', (done) => {
      exec((next) => {
        var scene;
        var sceneItems;
        Scene.getActiveScene()
    ...
    it('should be able to search for an item by ID', (done) => {
      exec((next) => {
        var scene;
        var sceneItems;
        Scene.getActiveScene()
    ...
    it('should be able to search by ID in a case-insensitive way', (done) => {
      exec((next) => {
        var scene;
        var sceneItems;
        Scene.getActiveScene()
    ...
    it('should be able to get null when searching for nonexistent ID', (done) => {
      exec((next) => {
        Scene.searchItemsById('{AAAAAAAA-AAAA-AAAA-AAAA-AAAAAAAAAAAA}').then((item) => {
    ...
    it('should be able to search for a scene with an item based on item id', (done) => {
      exec((next) => {
        Scene.getActiveScene()
          .then((result) => result.getItems())
          .then((items) => items[0].getId())
          .then((id) => Scene.searchScenesByItemId(id))
          .then((searchScene) => {
    ...
    it('should be able to search for an item by Name', (done) => {
      exec((next) => {
        var scene;
        var sceneItems;
        Scene.getActiveScene()
    ...
    it('should be able to get empty array when searching for nonexistent name', (done) => {
      exec((next) => {
        Scene.searchItemsByName('AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA').then((items) => {
    ...
    it('should be able to search for an item by a custom function', (done) => {
      exec((next) => {
        Scene.filterItems((item, resolve) => {
    ...
    it('should be able to search for a scene with an item based on a custom function', (done) => {
      exec((next) => {
        Scene.filterScenesByItems((item, resolve) => {
          item.getType().then((type) => {
            resolve(type === XJS.ItemTypes.HTML);
          });
        }).then((scene) => {
    ...
    it('should be able to get the sources', (done) => {
      exec((next) => {
        var scene;
        var sceneSources;
        Scene.getActiveScene()
    ...
    it('should be able to search for a source by ID', (done) => {
      exec((next) => {
        var scene;
        var sceneSource;
        Scene.getActiveScene()
    ...
    it('should be able to search by source ID in a case-insensitive way', (done) => {
      exec((next) => {
        var scene;
        var sceneSources;
        Scene.getActiveScene()
    ...
    it('should be able to get a blank array when searching for nonexistent source ID', (done) => {
      exec((next) => {
        Scene.searchSourcesById('{AAAAAAAA-AAAA-AAAA-AAAA-AAAAAAAAAAAA}').then((source) => {
          expect(source).toBeArray();
    ...
    it('should be able to search for a scene with an source based on source id', (done) => {
      navigator.__defineGetter__('appVersion', () => 'XSplit Broadcaster 3.0.1704.2101 ');
      Scene.getActiveScene()
        .then((result) => result.getSources())
        .then((sources) => sources[0].getId())
        .then((id) => Scene.searchScenesBySourceId(id))
        .then((searchScene) => {
    ...
    it('should be able to search for a source by Name', (done) => {
      exec((next) => {
        var scene;
        var sceneSources;
        Scene.getActiveScene()
    ...
    it('should be able to search for a source by a custom function', (done) => {
      exec((next) => {
        Scene.filterSources((source, resolve) => {
          source.getType().then((type) => {
            resolve(type === XJS.ItemTypes.HTML);
          });
        }).then((sources) => {
          expect(sources).toBeArray();
    ...
    it('should be able to search for a scene with a source based on a custom function', (done) => {
      exec((next) => {
        Scene.filterScenesBySources((source, resolve) => {
          source.getType().then((type) => {
            resolve(type === XJS.ItemTypes.HTML);
          });
        }).then((scene) => {
    ...
    it('should be able to initialize all scenes', (done) => {
      env.set(environments[0]);
      navigator.__defineGetter__('appVersion', () => 'XSplit Broadcaster 2.7.1702.2231 ');
    ...
    it('should be able to check if scene is empty or not', (done) => {
      env.set(environments[1]);
      exec((next) => {
        var scene;
        var sceneItems;
    ...
    describe('should be able to get available presets', () => {
      var scene;
      beforeEach((done) => {
        env.set(environments[1]);
        navigator.__defineGetter__(
          'appVersion',
          () =>
            '5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/68.0.3440.106 XSplitBroadcaster/3.9.1923.0602 Safari/537.36'
        );
        Scene.getActiveScene().then((result) => {
          scene = result;
          done();
        });
      });

      it('and return as an array', (done) => {
        scene.getPresets().then((presets) => {
          expect(presets).toBeArray();
          done();
        });
      });

      it('that has a default value', (done) => {
        scene.getPresets().then((presets) => {
      ...
      it('that fails in source plugins', (done) => {
        env.set(environments[2]);
        scene
          .getPresets()
          .then((presets) => {
      ...
      it('that fails for lower versions', (done) => {
        navigator.__defineGetter__('appVersion', () => 'XSplit Broadcaster 2.7.1702.2231 ');
        scene
          .getPresets()
          .then((presets) => {
    ...
    describe('should be able to add and remove a preset', () => {
      var scene;
      beforeEach((done) => {
        env.set(environments[1]);
        navigator.__defineGetter__(
      ...
      it('by returning/needing a preset UID string', (done) => {
        var newPresetUID;
      ...
      it('via methods that fail in source plugins', (done) => {
        env.set(environments[2]);
        scene
          .addPreset()
          .then((preset) => {
      ...
      it('via methods that fail for lower versions', (done) => {
        navigator.__defineGetter__('appVersion', () => 'XSplit Broadcaster 2.7.1702.2231 ');
        scene
          .addPreset()
          .then((preset) => {
    ...
    describe('should be able to get and set the active preset', () => {
      var scene;
      beforeEach((done) => {
        env.set(environments[1]);
        navigator.__defineGetter__(
      ...
      it('by returning/needing a preset UID string', (done) => {
        ...
        scene
          ...
          .then((activePreset) => scene.getActivePreset())
          .then((activePreset) => {
    ...
    describe('should be able to get and set the preset transition easing function', () => {
      var suppEasing = ['easeInCubic', 'easeOutCubic', 'easeInOutCubic'];
      ...
      it('by returning/needing a preset transition string', (done) => {
        var randomEasing;
        scene
      ...
      it('which accepts interprets blank as `none` and validates other values', (done) => {
        scene
          .setPresetTransitionEasing('')
          .then((isSet) => scene.getPresetTransitionEasing())
          .then((easing) => {
          ...
          .then(() => {
              ...
              'setPresetTransitionEasing should throw an error when easing transition string supplied is not supported'
            );
          })
          .catch((err) => {
            expect(err).toEqual(jasmine.any(Error));
    ...
    describe('should be able to get and set the preset transition time', () => {
      var scene;
      beforeEach((done) => {
        env.set(environments[1]);
        navigator.__defineGetter__(
      ...
      it('as a number', (done) => {
        ...
        scene
          ...
          .then(() => {
              ...
              'setPresetTransitionTime should throw an error when parameter supplied is not a number'
            );
          })
          .catch((err) => {
            expect(err).toEqual(jasmine.any(Error));
    ...
    describe('should be able to get and set overrides to scene transitions', () => {
      var scene;
      ...
      it('by returning/needing a transition object', (done) => {
        scene
          .setTransitionOverride(randomTransitionObj)
          .then(() => scene.getTransitionOverride())
          .then((transition) => {
    ...
    describe('should be able to get and set overrides to scene transition time', () => {
      var scene;
      var transitionKeys = Object.keys(XJS.Transition._transitionMap);
      var randomTransition = transitionKeys[Math.floor(Math.random() * transitionKeys.length)];
      var randomTransitionObj = XJS.Transition[randomTransition];
    ...
    xdescribe('should be able to reorder items within it', (done) => {
      beforeEach(() => {
        spyOn(window.external, 'SourcesListOrder').and.callFake((view, ids) => {
          ctr++;
      ...
      xit('from an array of sources or items', (done) => {});

      xit('from an array of item IDs', (done) => {});

      xit('even for scenes not loaded in the main view', (done) => {});

      xit('but rejects when called from the source', (done) => {});
    });
  });
});
