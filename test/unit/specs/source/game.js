...
describe('GameSource', () => {
  ...
  describe('interface method checking', () => {
    beforeEach(function (done) {
      if (enumerated.length > 0) {
        ...
        System.getGames().then(
          ((games) => {
            currentGameSource = new GameItem(games[games.length - 1]);
            done();
          }).bind(this)
        );
      }
    ...
    it('should implement the game interface', () => {
