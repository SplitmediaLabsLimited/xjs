...
describe('Config interface', () => {
  ...
  it('contains all the necessary config methods', () => {
    var methods = ['loadConfig', 'saveConfig', 'requestSaveConfig', 'applyConfig'].join(',');
