...
describe('Flash Source interface', () => {
  ...
  it('contains all the necessary flash methods', () => {
    var methods = [
      'getCustomResolution',
      'setCustomResolution',
      'getAllowRightClick',
  ...
  describe('should be able to get and set custom resolution', () => {
    ...
    it('as a Rectangle object', (done) => {
      ...
      firstSource
        .setCustomResolution(firstRec)
        .then(() => secondSource.setCustomResolution(secondRec))
        .then(() => firstSource.getCustomResolution())
        .then((rec1) => {
