...
describe('Audio Source', function() {
  ...
  describe('interface method checking', function() {
    ...
    it('should implement audio interface', function() {
      ...
      enumerated.forEach(function(currentSource) {
