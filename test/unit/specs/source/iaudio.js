...
describe('Audio interface', () => {
  ...
  describe('should be able to get and set volume', () => {
    ...
    it('as a number', (done) => {
      ...
      firstSource
        .setVolume(firstRand)
        .then(() => secondSource.setVolume(secondRand))
        .then(() => firstSource.getVolume())
        .then((volume1) => {
  ...
  describe('should be able to get and set mute state', () => {
    it('through a promise', (done) => {
    ...
    it('as a boolean', (done) => {
      ...
      firstSource
        .setMute(firstBoolean)
        .then(() => secondSource.setMute(secondBoolean))
        .then(() => firstSource.isMute())
        .then((mute1) => {
  ...
  describe('should be able to get and set auto mute state', () => {
    it('through a promise', (done) => {
    ...
    it('as a boolean', (done) => {
      ...
      firstSource
        .setAutoMute(firstBoolean)
        .then(() => secondSource.setAutoMute(secondBoolean))
        .then(() => firstSource.isAutoMute())
        .then((mute1) => {
          expect(mute1).toBeTypeOf('boolean');
          expect(mute1).toEqual(firstBoolean);
  ...
  describe('should be able to get and set stream only audio', () => {
    it('through a promise', (done) => {
    ...
    it('as a boolean', (done) => {
      ...
      firstSource
        .setStreamOnlyAudio(firstBoolean)
        .then(() => secondSource.setStreamOnlyAudio(secondBoolean))
        .then(() => firstSource.isStreamOnlyAudio())
        .then((streamOnly1) => {
