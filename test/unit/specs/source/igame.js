...
describe('Game Source interface', () => {
  ...
  it('contains all the necessary game methods', () => {
    var methods = [
  ...
  describe('should be able to get and set special optimization', () => {
    ...
    it('as a boolean', (done) => {
      firstSource
        .setSpecialOptimizationEnabled(randomBool)
        .then(() => firstSource.isSpecialOptimizationEnabled())
        .then((isOptimized) => {
  ...
  describe('should be able to get and set showing of mouse', () => {
    var randomBool = randomBoolean();
    it('through a promise', (done) => {
    ...
    it('as a boolean', (done) => {
      firstSource
        .setShowMouseEnabled(randomBool)
        .then(() => firstSource.isShowMouseEnabled())
        .then((isShown) => {
  ...
  describe('should be able to get and set offline image', () => {
    ...
    it('as a string', (done) => {
      secondSource
        ...
        .then(() => secondSource.getOfflineImage())
        .then((offlineImage) => {
    ...
    it('and rejects if not a valid file path or file type', (done) => {
      firstSource
        .setOfflineImage(invalidPath)
        .then((filePath) => {
  ...
  describe('should be able to get and set game source transparency', () => {
    var randomBool = randomBoolean();
    it('through a promise', (done) => {
    ...
    it('as a boolean', (done) => {
      firstSource
        .setTransparent(randomBool)
        .then(() => firstSource.isTransparent())
        .then((isTransparent) => {
  ...
  describe('should be able to get and set game fps cap', () => {
    it('through a promise', (done) => {
    ...
    it('as a number', (done) => {
      ...
      firstSource
        .setGameFPSCap(firstRand)
        .then(() => secondSource.setGameFPSCap(secondRand * Number(randomBool)))
        .then(() => firstSource.getGameFPSCap())
        .then((cap1) => {
