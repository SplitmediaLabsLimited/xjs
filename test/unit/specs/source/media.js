...
describe('MediaSource', () => {
  ...
  describe('interface method checking', () => {
    ...
    it('should implement the media interface', () => {
      expect(currentMediaSource).hasMethods(['getFileInfo'].join(','));
    });
