...
describe('Replay interface', () => {
  ...
  it('contains all the necessary audio methods', () => {
    var methods = [
      'getChannel',
      'setChannel',
      'getHotkey',
  ...
  describe('should be able to get and set channel', () => {
    ...
    it('as a string', (done) => {
      ...
      XJS.Output.getOutputList()
        ...
        .then(() => secondSource.setChannel(secondOutput))
        .then(() => firstSource.getChannel())
        .then((channel1) => {
  ...
  describe('should be able to get and set hotkey', () => {
    it('through a promise', (done) => {
    ...
    it('as a number', (done) => {
      ...
      var keyCombination =
        randomKey | (isShift ? 65536 : 0) | (isCtrl ? 131072 : 0) | (isAlt ? 262144 : 0);
      var keyCombination2 =
        randomKey | (!isShift ? 65536 : 0) | (!isCtrl ? 131072 : 0) | (!isAlt ? 262144 : 0);

      firstSource
        .setHotkey(keyCombination)
        .then(() => secondSource.setHotkey(keyCombination2))
        .then(() => firstSource.getHotkey())
        .then((hotkey1) => {
  ...
  describe('should be able to get and set replay time', () => {
    it('through a promise', (done) => {
    ...
    it('as a number', (done) => {
      ...
      firstSource
        .setReplayTime(firstRand)
        .then(() => secondSource.setReplayTime(secondRand))
        .then(() => firstSource.getReplayTime())
        .then((audioOffset1) => {
    ...
    it('which rejects when parameters are invalid', (done) => {
      firstSource
        .setReplayTime(121)
        .then((isSet) => {
  ...
  describe('should be able to start, stop and get replay state', () => {
    it('through a promise', (done) => {
    ...
    it('as a number', (done) => {
      firstSource
        .startReplay()
        .then(() => firstSource.getReplayState())
        .then((replayState) => {
