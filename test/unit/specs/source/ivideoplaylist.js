...
describe('VideoPlaylist Source interface', () => {
  ...
  it('contains all the necessary video methods', () => {
    var methods = [
      'getVideoNowPlaying',
      'setVideoNowPlaying',
  ...
  describe('should be able to get and set the playing video ', () => {
    it('through a promise', (done) => {
    ...
    it('as a string or as a number', (done) => {
      var videosOfFirst;
      var videosOfSecond;
      var firstRandom;
      var secondRandom;
      firstSource
        ...
        .then(() => secondSource.setVideoNowPlaying(secondRandom))
        .then(() => firstSource.getVideoNowPlaying())
        .then((video) => {
  ...
  describe('should be able to get and set the video sources ', () => {
    ...
    it('as an array of strings', (done) => {
      firstSource
        .getVideoPlaylistSources()
        .then((videos) => {
          expect(videos).toBeArray();
        ...
        .then(() => firstSource.getVideoPlaylistSources())
        .then((videos) => {
