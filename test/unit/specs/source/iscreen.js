...
describe('ScreenSource Interface', () => {
  var XJS = require('xjs');
  var Scene = XJS.Scene;
  ...
  it('contains all the necessary screen source interface methods', () => {
    var methods = [
      'isStickToTitle',
      'setStickToTitle',
      'getCaptureLayered',
  ...
  describe('should be able to get and set sticking to title', () => {
    ...
    it('as a boolean', (done) => {
      firstSource
        .setStickToTitle(randomBool)
        .then(() => firstSource.isStickToTitle())
        .then((shouldStick) => {
  ...
  describe('should be able to get and set capturing of layered windows', () => {
    var randomBool = randomBoolean();
    it('through a promise', (done) => {
    ...
    it('as a boolean', (done) => {
      firstSource
        .setCaptureLayered(randomBool)
        .then(() => firstSource.getCaptureLayered())
        .then((shouldCapture) => {
  ...
  describe('should be able to get and set capture optimization', () => {
    var randomBool = randomBoolean();
    it('through a promise', (done) => {
    ...
    it('as a boolean', (done) => {
      firstSource
        .setOptimizedCapture(randomBool)
        .then(() => firstSource.getOptimizedCapture())
        .then((shouldOptimize) => {
  ...
  describe('should be able to get and set to show mouse clicks', () => {
    var randomBool = randomBoolean();
    it('through a promise', (done) => {
    ...
    it('as a boolean', (done) => {
      firstSource
        .setShowMouseClicks(randomBool)
        .then(() => firstSource.getShowMouseClicks())
        .then((shouldOptimize) => {
          expect(shouldOptimize).toBe(randomBool);
  ...
  describe('should be able to get and set to show mouse', () => {
    var randomBool = randomBoolean();
    it('through a promise', (done) => {
    ...
    it('as a boolean', (done) => {
      firstSource
        .setShowMouse(randomBool)
        .then(() => firstSource.getShowMouse())
        .then((shouldOptimize) => {
          expect(shouldOptimize).toBe(randomBool);
  ...
  describe('should be able to get and set capture area', () => {
    it('through a promise', (done) => {
    ...
    it('as a Rectangle object', (done) => {
      ...
      firstSource
        ...
        .then(() => firstSource.getCaptureArea())
        .then((rec1) => {
  ...
  describe('should be able to get and set to just include client area', () => {
    var randomBool = randomBoolean();
    it('through a promise', (done) => {
    ...
    it('as a boolean', (done) => {
      firstSource
        .setClientArea(randomBool)
        .then(() => firstSource.isClientArea())
        .then((shouldOptimize) => {
          expect(shouldOptimize).toBe(randomBool);
