      ...
      Scene.getActiveScene().then(function(newScene) {
        ...
        if (sourceArrayLength > 0) {
          for (var i = 0; i < sourceArrayLength; i++) {
            if (sourceArray[i] instanceof XJS.AudioSource) {
