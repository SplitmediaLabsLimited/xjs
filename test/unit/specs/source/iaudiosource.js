...
describe('Audio Source interface', () => {
  var XJS = require('xjs');
  var Scene = XJS.Scene;
  ...
  it('contains all the necessary audio interface methods', () => {
    var methods = [
  ...
  describe('should be able to get and set silence detection state', () => {
    ...
    it('as a boolean', (done) => {
      ...
      firstSource
        .setSilenceDetectionEnabled(firstBoolean)
        .then(() => secondSource.setSilenceDetectionEnabled(secondBoolean))
        .then(() => firstSource.isSilenceDetectionEnabled())
        .then((mute1) => {
  ...
  describe('should be able to get and set silence threshold', () => {
    it('through a promise', (done) => {
    ...
    it('as a number', (done) => {
      ...
      firstSource
        .setSilenceThreshold(firstRand)
        .then(() => secondSource.setSilenceThreshold(secondRand))
        .then(() => firstSource.getSilenceThreshold())
        .then((threshold1) => {
    ...
    it('which rejects when invalid parameters are supplied', (done) => {
      firstSource
        .setSilenceThreshold('SOME TEXT')
        .then(() => {
          done.fail('Invalid type was accepted (string)');
        })
        .catch((err) => firstSource.setSilenceThreshold(130))
        .then(() => {
          done.fail('Value accepted is not within range');
        })
        .catch((err) => firstSource.setSilenceThreshold(2.5))
        .then(() => {
  ...
  describe('should be able to get and set silence period', () => {
    it('through a promise', (done) => {
    ...
    it('as a number', (done) => {
      ...
      firstSource
        .setSilencePeriod(firstRand)
        .then(() => secondSource.setSilencePeriod(secondRand))
        .then(() => firstSource.getSilencePeriod())
        .then((threshold1) => {
          expect(threshold1).toBeTypeOf('number');
          expect(threshold1).toEqual(firstRand);
    ...
    it('which rejects when invalid parameters are supplied', (done) => {
      firstSource
        .setSilencePeriod('SOME TEXT')
        .then(() => {
          done.fail('Invalid type was accepted (string)');
        })
        .catch((err) => firstSource.setSilencePeriod(20000))
        .then(() => {
          done.fail('Value accepted is not within range');
        })
        .catch((err) => firstSource.setSilencePeriod(2.5))
        .then(() => {
          done.fail('Only integers should be accepted');
        })
        .catch((err) => {
