...
export class ScreenItem extends Item implements IItemLayout, IItemColor,
  ...
  //Screen Source
  /**
   * See {@link #core/ScreenSource#stickToTitle stickToTitle}
   */
  stickToTitle: (value?: boolean) => Promise<boolean|ScreenItem>

  /**
   * See {@link #core/ScreenSource#captureLayered captureLayered}
   */
  captureLayered: (value?: boolean) => Promise<boolean|ScreenItem>

  /**
   * See {@link #core/ScreenSource#optimizedCapture optimizedCapture}
   */
  optimizedCapture: (value?: boolean) => Promise<boolean|ScreenItem>

  /**
   * See {@link #core/ScreenSource#showMouseClicks showMouseClicks}
   */
  showMouseClicks: (value?: boolean) => Promise<boolean|ScreenItem>

  /**
   * See {@link #core/ScreenSource#showMouse showMouse}
   */
  showMouse: (value?: boolean) => Promise<boolean|ScreenItem>

  /**
   * See {@link #core/ScreenSource#captureArea captureArea}
   */
  captureArea: (dimension?: Rectangle) => Promise<Rectangle|ScreenItem>

  /**
   * See {@link #core/ScreenSource#clientAreaOnly clientAreaOnly}
   */
   ...
   */
  setCanvasRotate: (value: number) => Promise<ScreenItem>;

  /**
   * See: {@link #core/IItemLayout#setCropping setCropping}
   */
  setCropping: (value: Object) => Promise<ScreenItem>;

  /**
   * See: {@link #core/IItemLayout#setCroppingEnhanced setCroppingEnhanced}
   */
  setCroppingEnhanced: (value: Object) => Promise<ScreenItem>;
   ...
   */
  setFullDynamicColorRange: (value: boolean) => Promise<ScreenItem>;
