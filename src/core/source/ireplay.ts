    ...
    return new Promise((resolve, reject) => {
      if (typeof channel === 'string') {
        if (this._isItemCall) {
          ...
          iItem.set('prop:presproperty:channelName', channel, this._id).then((val) => {
            resolve(this);
          });
        } else {
          iItem
    ...
    return new Promise((resolve, reject) => {
      if (typeof hotkey === 'number') {
        if (this._isItemCall) {
          ...
          iItem.set('prop:presproperty:hotkey', String(hotkey), this._id).then((val) => {
            resolve(this);
          });
        } else {
          iItem
    ...
    return new Promise((resolve, reject) => {
      if (typeof buffer === 'number') {
        if (buffer > 120 || buffer < 0) {
          ...
          iItem.set('prop:presproperty:buffer', String(buffer), this._id).then((val) => {
            resolve(this);
          });
        } else {
          iItem
  ...
  startReplay(): Promise<SourceReplay> {
    return new Promise((resolve, reject) => {
      if (this._isItemCall) {
        ...
        iItem.set('prop:ReplayActive', '1', this._id).then((val) => {
          resolve(this);
        });
      } else {
        iItem
          .wrapSet('prop:ReplayActive', '1', this._srcId, this._id, this._updateId.bind(this))
          .then((val) => {
            resolve(this);
          });
      }
  ...
  stopReplay(): Promise<SourceReplay> {
    return new Promise((resolve, reject) => {
      if (this._isItemCall) {
        ...
        iItem.set('prop:ReplayActive', '0', this._id).then((val) => {
          resolve(this);
        });
      } else {
        iItem
          .wrapSet('prop:ReplayActive', '0', this._srcId, this._id, this._updateId.bind(this))
          .then((val) => {
            resolve(this);
          });
      }
